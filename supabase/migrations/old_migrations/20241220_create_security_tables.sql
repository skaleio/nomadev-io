-- =====================================================
-- MIGRACIÓN DE SEGURIDAD ANTI-HACKEO
-- =====================================================
...
-- Crear usuario de servicio para limpieza automática
-- (Esto se haría en el panel de Supabase o con service role)
...
-- Programar detección de actividad sospechosa
