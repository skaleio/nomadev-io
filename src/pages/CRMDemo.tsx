...
const CRMDemo: React.FC = () => {
  useDocumentTitle('CRM Demo - NOMADEV.IO');
  ...
  const loadCRMData = async () => {
    try {
      ...
      console.log('CRM Demo data loaded - pipeline empty until Shopify connection');
    } catch (error) {
      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-white">CRM Demo</h1>
                  ...
                  {stage.leads.length === 0 ? (
                    <div className="text-center py-8">
                      ...
                      <p className="text-gray-500 text-xs mt-1">
                        Conecta Shopify para ver leads reales
                      </p>
                    </div>
                  ) : (
