...
const LeadsDemo = () => {
  ...
  const liveMetrics = [
    { label: "Visitantes", value: "0", icon: Eye },
    { label: "Ventas", value: "$0", icon: DollarSign },
    { label: "Sesiones", value: "0", icon: Clock },
    { label: "Pedidos", value: "0", icon: Package }
  ];

  const leadsMetrics = [
    { title: "Leads Totales", value: "0", change: "0%", icon: Users, color: "text-blue-500" },
    { title: "Nuevos Hoy", value: "0", change: "0%", icon: UserPlus, color: "text-emerald-500" },
    { title: "Conversión", value: "0%", change: "0%", icon: Target, color: "text-purple-500" },
    { title: "Valor Promedio", value: "$0", change: "0%", icon: DollarSign, color: "text-orange-500" }
  ];
  ...
  const getCurrentSectionInfo = () => {
    return {
      ...
      description: "Sistema de gestión y seguimiento de leads potenciales con scoring automático, pipeline de ventas y automatización de seguimiento."
    };
  };
  ...
  const getActivityIcon = (type: string) => {
    switch (type) {
      ...
      case 'proposal': return <Target className="h-4 w-4 text-orange-500" />;
      ...
      <main className="pt-16 ml-64 min-h-screen">
        <div className="p-6">
          <div className="space-y-6">
            <div>
              <h1 className="text-3xl font-bold text-foreground mb-2">Gestor de Leads</h1>
              <p className="text-muted-foreground">Sistema de gestión y seguimiento de leads potenciales</p>
            </div>
            ...
            {/* Leads Principales y Actividades */}
              ...
              <Card className="bg-card border-border">
                ...
                <CardContent>
                  <div className="space-y-4">
                    {hotLeads.map((lead) => (
                      <div key={lead.id} className="p-4 bg-muted/50 rounded-lg">
                    ...
                    {recentActivities.map((activity) => (
                      <div key={activity.id} className="flex items-center gap-3 p-3 bg-muted/30 rounded-lg">
                        ...
                        <div className="flex-1">
                          <p className="font-medium text-foreground">{activity.lead}</p>
              ...
              <div className="flex justify-between">
                ...
                <Button
                  onClick={() => {
                    ...
                    navigate(getDemoRoute('settings'));
                  }}
                  size="sm"
