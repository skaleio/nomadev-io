      ...
      <aside className="fixed left-0 top-0 h-full w-64 bg-sidebar border-r border-sidebar-border z-40">
        ...
        <nav className="space-y-2 p-4">
          {navigationItems.map((item, index) => {
            const isActive = item.id === 'validation';
      ...
      <main className="pt-16 ml-64 min-h-screen">
        <div className="p-6">
          <div className="space-y-6">
            <div>
              <h1 className="text-3xl font-bold text-foreground mb-2">Validador de Clientes</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <Card className="bg-card border-border">
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-muted-foreground text-sm font-medium">Clientes Validados</p>
                      <p className="text-2xl font-bold text-foreground mt-1">2,847</p>
                      <p className="text-emerald-500 text-sm mt-1">+15.3%</p>
                    </div>
              ...
              <Card className="bg-card border-border">
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-muted-foreground text-sm font-medium">Fraudes Detectados</p>
                      <p className="text-2xl font-bold text-foreground mt-1">23</p>
                      <p className="text-red-500 text-sm mt-1">-8.2%</p>
                    </div>
                    <div className="p-3 rounded-lg bg-muted">
              ...
              <Card className="bg-card border-border">
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-muted-foreground text-sm font-medium">Tasa de Precisión</p>
                      <p className="text-2xl font-bold text-foreground mt-1">99.9%</p>
                      <p className="text-emerald-500 text-sm mt-1">+0.1%</p>
                    </div>
                    <div className="p-3 rounded-lg bg-muted">
              ...
              <Card className="bg-card border-border">
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-muted-foreground text-sm font-medium">Validaciones Hoy</p>
                      <p className="text-2xl font-bold text-foreground mt-1">156</p>
                      <p className="text-emerald-500 text-sm mt-1">+12.7%</p>
                    </div>
                    <div className="p-3 rounded-lg bg-muted">
              ...
              <Card className="bg-card border-border">
                ...
                <CardContent>
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between p-3 bg-emerald-500/10 rounded-lg">
                      <span className="text-foreground">Teléfono Validado</span>
                      <CheckCircle className="h-5 w-5 text-emerald-500" />
                    </div>
                    <div className="flex items-center justify-between p-3 bg-emerald-500/10 rounded-lg">
                      <span className="text-foreground">Documento Verificado</span>
                      <CheckCircle className="h-5 w-5 text-emerald-500" />
                    </div>
                  </div>
                </CardContent>
                ...
                <CardContent>
                  <div className="space-y-3">
                    <div className="p-3 bg-red-500/10 border border-red-500/20 rounded-lg">
                      <p className="text-sm text-red-400 font-medium">IP Sospechosa Detectada</p>
                      <p className="text-xs text-muted-foreground">192.168.1.100 - 2 intentos fallidos</p>
                    </div>
                    <div className="p-3 bg-yellow-500/10 border border-yellow-500/20 rounded-lg">
                      <p className="text-sm text-yellow-400 font-medium">Email Duplicado</p>
              ...
              <div className="flex justify-between">
                ...
                <Button
                  onClick={() => {
                    ...
                    navigate(getDemoRoute('analytics'));
                  }}
                  size="sm"
