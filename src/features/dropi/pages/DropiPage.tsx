...
import { useDropiConnection } from "@/features/dropi/hooks/useDropiConnection";
import { dropi, disconnectDropi } from "@/features/dropi/lib/dropi-service";
...
export default function DropiPage() {
  ...
  const handleDisconnect = async () => {
    try {
      ...
      // Disconnect falla silenciosamente; el refresh actualiza el estado UI
    }
  };
